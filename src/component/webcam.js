...
function WebCam() {
      ...
      .then((videoStream) => {
        navigator.mediaDevices
          ...
          .catch((error) => {
            ...
            toast.error("Error starting screen recording. Please try again.");
          });
      })
      .catch((error) => {
  ...
  const startCameraRecording = () => {
    navigator.mediaDevices
      .getUserMedia({ video: true, audio: true }) // Request both audio and video
      .then((stream) => {
      ...
      .catch((error) => {
        ...
        toast.error("Error starting camera recording. Please try again.");
      });
  };
